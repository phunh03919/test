...
Public Class frmSanPham
    ...
    Dim chuoiketnoi As String = "workstation id=SanPham.mssql.somee.com;packet size=4096;user id=phuhoang993_SQLLogin_3;pwd=l9lkjd133h;data source=SanPham.mssql.somee.com;persist security info=False;initial catalog=SanPham"
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        conn.Open()
        Dim refesh As SqlDataAdapter = New SqlDataAdapter("select MaSP as 'Mã SP' ,TenSP as 'Tên Sản phẩm', SoLuong as 'Số lượng', DonGia as 'Đơn giá' from SANPHAM", conn)
        db.Clear()
        refesh.Fill(db)
